...
export default function ProductCard({ id, title, price, image, rating}) {
  return (
    <div className={`bg-white rounded-lg shadow p-4 hover:scale-105 transition transform`}>
      ...
      {rating && (
        <p className="flex items-center text-orange-400 mt-1">
      ...
      <Link
        to={`/product/${id}`}
        className="mt-3 inline-block bg-orange-400 font-bold text-orange-200 px-3 py-1 rounded hover:bg-orange-500"
      >
        Ver detalhes
      </Link>
    </div>
